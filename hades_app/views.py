...
class RolesViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"success": False, "error": "Error al obtener rol", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def list(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"success": False, "error": "Error al listar roles", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"success": False, "error": "Error al eliminar rol", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
            ...
            if page is not None:
                ...
                for perm_item in serializer.data:
                    permission = Permissions.objects.get(
                        id_permissions_pk=perm_item["id_permissions_pk"]
                    )
